...
Oraclize is the leading oracle service for smart contracts and blockchain applications, serving thousands of requests every day on platforms like [Ethereum](#ethereum), [Rootstock](#rootstock), [R3 Corda](#corda), [Hyperledger Fabric](#fabric) and [EOS](#eos).
